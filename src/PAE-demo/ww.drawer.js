...
var metal_hulk= {
  ...
  relSiz: .5, //Player Relative Size....should only increase size of player...not ready for activ redrawing.
  ...
  drawObjInfo: function(){
    ...
    ctxWorker.fillRect( this.posX+this.modW*1.05, this.posY+this.modH*1.05, this.modW*3.5, this.modH*2 );
...
var metal_hulk2= {
  ...
  posX: 1500, // Player offset from the top of the canvas or the [ posX ]....should change to map pos X.
  posY: 1500, // Basically same thing just Y...from top left corner 
  modW: 128, // Width of the object
  modH: 125, // Height of it
  DxSc: 0,
  DySc: 0,
...
var metal_hulk3= {
  pname: 'PussyBreaker_69',
  relSiz: 2, //Player Relative Size....should only increase size of player...not ready for activ redrawing.
  posX: 550, // Player offset from the top of the canvas or the [ posX ]....should change to map pos X.
...
var metal_hulk4= {
  pname: 'PussyBreaker_69',
  relSiz: .225, //Player Relative Size....should only increase size of player...not ready for activ redrawing.
  posX: 3500, // Player offset from the top of the canvas or the [ posX ]....should change to map pos X.
  posY: 250, // Basically same thing just Y...from top left corner 
  modW: 128, // Width of the object
  modH: 125, // Height of it
  DxSc: 0,
...
var metal_hulk5= {
  pname: 'PussyBreaker_69',
  relSiz: 5, //Player Relative Size....should only increase size of player...not ready for activ redrawing.
  posX: 50, // Player offset from the top of the canvas or the [ posX ]....should change to map pos X.
  posY: 2000, // Basically same thing just Y...from top left corner 
  modW: 128, // Width of the object
  modH: 125, // Height of it
  DxSc: 0,
  DySc: 0,
